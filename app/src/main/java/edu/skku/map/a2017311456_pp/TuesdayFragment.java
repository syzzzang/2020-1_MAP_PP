...
public class TuesdayFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerView recyclerView=(RecyclerView)view.findViewById(R.id.tuesday_list);
    ...
    public void initDataset(){
        posts.clear();
        DatabaseReference pref= FirebaseDatabase.getInstance().getReference("user_list").child(name).child("day").child("Tue");
        ValueEventListener valueEventListener=new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for(DataSnapshot data:dataSnapshot.getChildren()){
                    ...
                    Log.d("check",check);
                    posts.add(new Posts(todo,check,name,"Tue"));
                    reset();
                }

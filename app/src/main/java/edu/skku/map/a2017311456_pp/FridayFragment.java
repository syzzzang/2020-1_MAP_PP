...
public class FridayFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerView recyclerView=(RecyclerView)view.findViewById(R.id.friday_list);
    ...
    public void initDataset(){
        posts.clear();
        DatabaseReference pref= FirebaseDatabase.getInstance().getReference("user_list").child(name).child("day").child("Fri");
        ValueEventListener valueEventListener=new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for(DataSnapshot data:dataSnapshot.getChildren()){
                    ...
                    Log.d("check",check);
                    posts.add(new Posts(todo,check,name,"Fri"));
                    reset();
                }
